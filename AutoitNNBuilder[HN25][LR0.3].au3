...
Global $g_iNeuralNetworkName = "MNIST_test_3000_[HR"&$tempHN&"][LR" & $tempLR&"]"
...
_testBeforeTrainNetwork(@ScriptDir&"\mnist_train_3000.csv", @ScriptDir& "\mnist_test_1000.csv")
